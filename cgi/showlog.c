...
int main(void) {
	...
	if(display_header == TRUE) {
		...
		display_info_table((log_rotation_method == LOG_ROTATION_NONE || log_archive == 0) ? "現在のイベントログ" : "過去のイベントログ", FALSE, &current_authdata);
		printf("</td>\n");
